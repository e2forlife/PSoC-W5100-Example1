...
#define W5100_READ_OP         ( 0x0F )
#define W5100_WRITE_OP        ( 0xF0 )

#define W5100_IPADDRESS(x1,x2,x3,x4)   ( (uint32)(x1&0x000000FF) + (uint32)((x2<<8)&0x0000FF00) + (uint32)((x3<<16)&0x00FF0000) + ((uint32)(x4<<24)&0xFF000000 ))

#define W5100_PROTO_TCP        ( 1 )
#define W5100_PROTO_UDP        ( 2 )
#define W5100_PROTO_IP         ( 3 )
#define W5100_PROTO_MAC        ( 4 )
 ...
 *
 * \note this function is usuallt called from W5100_Start()
 * \sa W5100_Start()
 */
 ...
 * \sa W5100_TcpOpen()
 * \sa W5100_TcpStartServer()
 * \sa W5100_TcpStartServerWait()
 * \sa W5100_TcpConnected()
 * \sa W5100_TcpDisconnect()
 */
 ...
 *
 * this function is a shortcut to using the W5100_TcpSend()
 ...
 * \sa W5100_UdpSend()
 */
uint16 W5100_UdpReceive(uint8 socket, uint32 *ip, uint16 *port, uint8* buffer, uint16 length);
